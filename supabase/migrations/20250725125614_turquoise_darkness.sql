/*
  ...
  1. Sample Challenges
    - Basic file operations challenges
...
-- Update the sequence to ensure future IDs don't conflict
-- This is handled automatically by PostgreSQL for UUID primary keys